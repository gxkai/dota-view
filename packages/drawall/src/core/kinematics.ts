...
import { areEq, Memo, Ref, RefK, Refs, RefView, RoRef } from "@/core/util";
import { Distance, Distances, EdgeLike, Position, SDF, SpaceRay, Surface, Vector, Vectors } from "@/core/spaces";
...
export class PhysNode extends Component implements Solo, Surface, PointMass {
  readonly [SOLO] = true;
...
export class MemoEdge implements EdgeLike {
...
export class PhysEdge extends Component implements Solo, Surface {
...
export const Kinematics = (ecs: EntityComponentSystem) => {
