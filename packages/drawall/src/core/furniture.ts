import { argmin, impossible, Ref, Refs, reverseInPlace, RoRef } from "@/core/util";
import { Component, ComponentFactories, Eid, Entity, EntityComponentSystem, SOLO, Solo } from "@/core/ecs";
import { BLUE, Form, PINK } from "@/core/ux";
import { JsonObject, MoreJson, SavedComponent } from "@/core/io/json";
import { Icons } from "@/core/icons";
import { DragPoint } from "@/core/dragging";
import { Rectangular } from "@/core/rectangular";
import { Popup } from "@/core/popups";
import { Angle, Distance, Positions, Vector, Vectors } from "@/core/spaces";
import { Axis, Radians, Vec } from "@/core/linalg";
...
import { MemoEdge, PhysEdge } from "@/core/kinematics";
...
export interface FurnitureAttach {
  wall: Wall;
  at: number;
  normal: Distance;
  point: DragPoint;
...
export const createFurnitureType = (atts: Partial<FurnitureTypeProps>): FurnitureTypeProps => ({
  flippable: false,
  keepOnWall: false,
...
export type FurnitureType = (keyof typeof FurnitureTypes) & string;

export class Furniture extends Component implements Solo {
...
export const FurnitureRenderer = (ecs: EntityComponentSystem) => {
