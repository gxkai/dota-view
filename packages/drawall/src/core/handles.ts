import { Component, ComponentFactories, Entity, EntityRef, SOLO, Solo } from "@/core/ecs";
import { Ref, RefK, Refs, RefView, RoRef } from "@/core/util";
import { UiEventDispatcher } from "@/core/uievents";
import { SavedComponent } from "@/core/io/json";
import { Cursor } from "@/core/cursors";
import { Circle, Distance, Distances, Polygon, Position, SDF, Surface, Vector, Vectors } from "@/core/spaces";
import { ToolName } from "@/core/tools";
import { DragClosure, DragItem, Drags } from "@/core/dragging";
import { App } from "@/core/app";
import { CanvasColor } from "@/core/canvas";
...
export class Surfaced extends Component implements Surface, Solo {
...
export class Dragging extends Component implements Solo {
  public readonly [SOLO] = true;
...
export class Hovered extends Component implements Solo {
  public readonly [SOLO] = true;
...
export class Selected extends Component implements Solo {
  public readonly [SOLO] = true;
...
export class Handle extends Component implements Solo {
  public readonly [SOLO] = true;
