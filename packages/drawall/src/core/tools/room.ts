...
import { Room, Wall } from "@/core/model";
import { Tool } from "@/core/tools-type";
import { App } from "@/core/app";
import { Counter } from "@/core/util";
import { Arrow } from "@/core/canvas";
import { Axis } from "@/core/linalg";

export class DrawRoomTool extends Tool {
...
export interface LoopMergeResult {
  outcome: 'keep a' | 'keep b' | 'keep both';
  walls: Wall[];
}

export interface RoomIntersectionPoint {
  position: Position;
  wall1: Wall;
  wall2: Wall;
}
