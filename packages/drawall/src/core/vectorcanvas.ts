import { Angle, Distance, Position, Rect, Vector } from "@/core/spaces";
import { Counter } from "@/core/util";
import { TextDrawProps } from "@/core/canvas";
...
export type SvgAttribute = string | number | Array<string | number>;

export interface SvgAttributes {
  [key: string]: SvgAttribute;
}

export type CoallesceElement = string | number | undefined | SvgAttribute;

export const coallesce = <V>(...items: V[]): V | undefined => {
...
export class VectorCanvas implements CanvasApi {
