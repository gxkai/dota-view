import { EntityComponentSystem } from "@/core/ecs";
import { VectorCanvas } from "@/core/vectorcanvas";
import { FurnitureRenderer } from "@/core/furniture";
import { Refs } from "@/core/util";
import { ProjectHistory } from "@/core/history";
import { formatKeyBinding, Keybindings } from "@/core/hotkeys";
import { Time } from "@/core/time";
import { GUI } from "@/core/gui";
import { UiState } from "@/core/ux";
import { Settings } from "@/core/settings";
import {
  AngleRenderer,
  AxisConstraintRenderer,
  Recycler,
  RoomRenderer,
  WallJointRenderer,
  WallRenderer
} from "@/core/model";
import { Position } from "@/core/spaces";
import { RectangularRenderer } from "@/core/rectangular";
import { Tools } from "@/core/tools";
import { Canvas2d, GridRenderer, MarkupRenderer, Viewport } from "@/core/canvas";
import { Point } from "@/core/linalg";
import { Project } from "@/core/project";
import { ConstraintEnforcer } from "@/core/constraints";
import { UserActions } from "@/core/actions";
import { ImageExporter } from "@/core/io/exportpng";
import { IoUtil } from "@/core/io/ioutil";
import { Kinematics } from "@/core/kinematics";
import { RulerRenderer } from "@/core/tools/ruler";
...
export const DebugRenderer = (ecs: EntityComponentSystem) => {
  if (!App.debug) return;
