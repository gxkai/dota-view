import { Kinds, MultiMap, Not } from "@/core/util";
import { Position, Vector } from "@/core/spaces";
...
export type UiEventListener<E> = (event: E) => void;

export type UiEventListenerMap<Event> = MultiMap<Kinds<Event>, UiEventListener<Event>>;
...
export class UiEventDispatcher implements UiEventHandler {
