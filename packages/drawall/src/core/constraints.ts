import { Component, ComponentFactories, Entity, EntityComponentSystem } from "@/core/ecs";
import { Axis, clamp01, Degrees, formatDegrees, lerp, Radians, Sign, toDegrees } from "@/core/linalg";
import { impossible, Refs, RoRef } from "@/core/util";
import { Form } from "@/core/ux";
import { Icons } from "@/core/icons";
import { JsonObject, MoreJson, SavedComponent } from "@/core/io/json";
import { Angle, Angles, Distance, Position, Spaces, Vector, Vectors } from "@/core/spaces";
import { Time } from "@/core/time";
import { Unit, Units } from "@/core/units";
...
export type ConstraintStatus = 'satisfied' | 'under' | 'over';
...
export interface ConstraintColoring {
  satisfied?: string;
  under?: string;
  over?: string;
}

export const signToErrorStatus = (s: Sign): ConstraintStatus => {
  if (s === -1) return 'under';
...
export const ConstraintEnforcer = (ecs: EntityComponentSystem) => {
